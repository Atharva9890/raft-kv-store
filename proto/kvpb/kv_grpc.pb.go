...
const (
	Raft_RequestVote_FullMethodName     = "/kv.Raft/RequestVote"
	Raft_AppendEntries_FullMethodName   = "/kv.Raft/AppendEntries"
	Raft_InstallSnapshot_FullMethodName = "/kv.Raft/InstallSnapshot"
)
